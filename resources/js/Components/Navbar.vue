	...
	<div class="hidden md:block w-40 mt-5">
        <div>
            <ul>
                ...
                <li class="flex items-center hover:bg-gray-900 rounded-full p-2">
                ...
                <Link :href="route('user.notifications')" v-if="$page.props.auth.user">
                    <li class="flex items-center hover:bg-gray-900 rounded-full p-2" href="#">
                ...
                <Link :href="route('login')" v-if="!$page.props.auth.user">
                    <li class="flex items-center hover:bg-gray-900 rounded-full p-2" href="#">
                        ...
                        <p class="ml-2 font-extrabold">Login</p>
                    </li>
                </Link>
                ...
                <div class="mt-3 ml-2"  v-if="$page.props.auth.user">
                    <button type="button" @click="openModal" class="flex justify-center items-center bg-gray-100 rounded-full px-5 py-1 font-extrabold text-gray-900">
                        Create
                    </button>
                </div>
                ...
                <Dialog as="div" @close="closeModal" class="relative z-10">
                  ...
                  <div class="fixed inset-0 overflow-y-auto">
                    <div
                      class="flex h-auto mt-10 items-center justify-center p-4 text-center"
                    >
                      <TransitionChild
                        as="template"
                        enter="duration-300 ease-out"
